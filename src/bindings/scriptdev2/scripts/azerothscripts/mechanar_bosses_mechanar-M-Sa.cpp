...
CreatureAI* GetAI_bosses_mechanar(Creature *_Creature)
{
    ...
    case 19219: 
        ...
        ai->Spell[2].Cooldown = 18000;
        ai->Spell[2].First_Cast = 27000;
...
void AddSC_bosses_mechanar_azsc()
{
    Script *newscript;
    newscript = new Script;
    newscript->Name="bosses_mechanar_azsc";
    newscript->GetAI = GetAI_bosses_mechanar;
    newscript->RegisterSelf();
}

// extern void AddSC_bosses_mechanar_azsc();

// AddSC_bosses_mechanar_azsc();
