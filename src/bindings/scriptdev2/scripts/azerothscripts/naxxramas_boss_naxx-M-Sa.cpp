...
CreatureAI* GetAI_boss_naxx(Creature *_Creature)
{
    ...
    case 15989: 
        ai->Spell[0].Enabled = true;              
        ai->Spell[0].Spell_Id = 36279;   // icebolt School Damage (Frost) Value: 1,5k      
    ...
    case 15928: 
        ai->Spell[0].Enabled = true;           
        ai->Spell[0].Spell_Id = 31330;      // chain lightning Strikes an enemy with a lightning bolt that arcs to another nearby enemy. The spell affects up to 3 targets, causing Nature damage to each.     
        ai->Spell[0].Cooldown = 15000;          
...
void AddSC_boss_naxx_azsc()
{
    Script *newscript;
    newscript = new Script;
    newscript->Name="boss_naxx_azsc";
