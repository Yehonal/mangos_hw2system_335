...
void Player::UpdateArea(uint32 newArea)
{
    ...
    //[HW2] se la flag pvp � attiva e sei nelle zone tournament allora � attiva ovunque, se invece � disattivata nel torneo non sar� attiva mentre 
...
void Player::SendInitialPacketsBeforeAddToMap()
{
    ...
    data << uint32(secsToTimeBitFields(sHw2.GetModGameTime()));
